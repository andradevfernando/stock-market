...
type StockAnalysisResponse struct {
	...
	Reason         string  `json:"reason" example:"Exemplo: Alta taxa de PE em comparação à média do setor"`           // Exemplo: "Exemplo: Alta taxa de PE em comparação à média do setor"
	Recommendation string  `json:"recommendation" example:"Exemplo: Comprar este ativo"`                               // Exemplo: "Exemplo: Comprar este ativo"
	Comment        string  `json:"comment" example:"Exemplo: O ativo possui potencial de valorização apesar do risco"` // Exemplo: "Exemplo: O ativo possui potencial de valorização apesar do risco"
